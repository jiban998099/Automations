 ...
 * @author Jiban
 */
public class BothAPIFNAvlDateCalc {

    public static void main(String[] args) {
        String inputFilename = "C:\\Users\\jpradhan\\OneDrive - Williams-Sonoma Inc\\Documents\\RJ_GMTP_Adhoc\\bothAPIDocs\\BothAPIFNEndDateCalc.csv"; // Path to the input CSV file
        String outputFilename = "C:\\Users\\jpradhan\\OneDrive - Williams-Sonoma Inc\\Documents\\RJ_GMTP_Adhoc\\bothAPIDocs\\BothAPIFNAvlDateCalc.csv"; // Path to the output CSV file
