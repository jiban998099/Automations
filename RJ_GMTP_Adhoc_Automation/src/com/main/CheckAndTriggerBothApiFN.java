 ...
 * @author Jiban
 */
public class CheckAndTriggerBothApiFN { 
    
    private static final Logger logger = Logger.getLogger(CheckAndTriggerBothApiFN.class);
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            FileInputStream file = new FileInputStream(new File("C:\\Users\\jpradhan\\OneDrive - Williams-Sonoma Inc\\Documents\\RJ_GMTP_Adhoc\\bothAPIDocs\\BothAPIFNAvlDateCalc.csv"));
