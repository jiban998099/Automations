...
public class DBConnection {
	...
	public static Connection getSterlingDBConnection() {
		...
		try {
			dbConnection = DriverManager.getConnection(STR_DB_CONNECTION, STR_DB_USER,
					STR_DB_PASSWORD);
			System.out.println("Connected to PROD");
	...
	private static void init() {
		...
		try {
			properties.load(new FileInputStream("C:\\Users\\jpradhan\\OneDrive - Williams-Sonoma Inc\\Documents\\workspace\\POcleException\\src\\Connection.properties"));
